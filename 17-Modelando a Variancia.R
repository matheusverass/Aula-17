...
plot(previsao1,type="o", main="Volatilidade do Icon", ylab="Preço", xlab="Data", col="Blue")
grid(col = "black", lty = "dotted")
     
previsao2 <- predict(GARCH71,IntegradaOrdem1,15)
plot(previsao2,type="o", main="Volatilidade do Icon", ylab="Preço", xlab="Data", col="Blue")
grid(col = "black", lty = "dotted")